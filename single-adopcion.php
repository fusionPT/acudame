		...
		<?php if(have_posts() ) : while(have_posts() ) : the_post(); ?>
		 ...
		 <div class="avatar-wrapper">
            ...
            <dl>
                ...
                <dd>
                <?php 
				$fecha = get_field('fecha_nacimiento');
				
                $data_nacimiento = DateTime::createFromFormat('dmY', $fecha); echo $data_nacimiento->format('m/Y');
	                
	            $hoy = new DateTime('today');
				$edad_actual = $data_nacimiento->diff($hoy)->y;
				if($edad_actual <= 0 ) {
